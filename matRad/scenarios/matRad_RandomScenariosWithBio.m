classdef matRad_RandomScenariosWithBio < matRad_ScenarioModel
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    properties (SetAccess=protected)
        name = 'Randomly sampled Scenarios with biological shifts in alpha and beta';
        shortName   = 'rndScenwithBio';        
    end
    
    methods
        function this = matRad_RandomScenariosWithBio(ct)           
            if nargin == 0 
                superclassArgs = {};
            else
                superclassArgs = {ct};
        ...
        function scenarios = updateScenarios(this)
            ...
            %Multivariate Normal Sampling + biology
            Sigma = diag([this.shiftSD,this.rangeAbsSD,this.rangeRelSD./100,this.bioRelSD./100].^2);
            d = size(Sigma,1);
            [cs,p] = chol(Sigma);
            ...
            %      cs = sqrt(L) * V';
            %end
            %transform normal samples, mean is always zer            
            ...
            %Create phase and setup/range/biology probabilities
            ...
            this.alphaShift = scenarios(:,7);
            this.betaShift = scenarios(:,8);
